...
<div class="card-group">
  <div class="mybox" style="width:100%; margin:auto;">
    ...
    <div class="card">
    <center><img style="width:60%;" src="images/ACCOUNT.JPG" alt="Card image cap">
      <div>
  ...
  <div class="mybox" style="width:100%; margin:auto;">
    ...
    <div class="card">
    <center><img style="width: 40%;" src="images/200.gif" alt="Card image cap">
      <div>
  ...
  <div class="mybox" style="width:100%; margin:auto;">
    ...
    <div class="card">
    <center><img style="width: 40%;" src="images/trans.jpg" alt="Card image cap">
      <div>
...
<footer class="text-center mt-5 py-2 bg-light text-dark">
            <p> <b> Copyright &copy  2021 Made by Tanzil Pasha</b> <br>  
            <a href="mailto:tanzilpasha1@gmail.com" onmouseover="this.style.color='aqua'" onmouseout="this.style.color='red'">tanzilpasha1@gmail.com<i class="fab fa-mail fa-2x"></i></a>
            </p>
          <div class="symbol">
                 <a href="https://github.com/tanzil7786" onmouseover="this.style.color='blue'" onmouseout="this.style.color='green'" ><i class="fab fa-github fa-2x"></i></a>
                  <a href="https://www.linkedin.com/in/tanzil-pasha-a4279316b/" onmouseover="this.style.color='blue'" onmouseout="this.style.color='blue'"><i class="fab fa-linkedin fa-2x"></i></a>
				   <a href="https://www.youtube.com/channel/UCwEJ7OPwNrJInpjD0vROKYA" onmouseover="this.style.color='red'" onmouseout="this.style.color='red'"><i class="fab fa-youtube fa-2x"></i></a>
